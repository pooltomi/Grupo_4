...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Total Empleados Fabrica " + EMPLEADOS);
		...
		if (totalDeEmpleadosSector1 <= EMPLEADOS) {
			...
			System.out.println("Ingrese cantidad de empleados sector 2  : "); // recuerde que no puede ser mayor a "
			...
			if (totalDeEmpleadosSector2 <= restanEmpleados) {
				...
				System.out.println("Ingrese cantidad de empleados sector 3 : "); // recuerde que no puede ser mayor a "
				// + format.format(restanEmpleados) + " :");
				totalDeEmpleadosSector3 = scan.nextInt();
				if (totalDeEmpleadosSector3 <= restanEmpleados) {
